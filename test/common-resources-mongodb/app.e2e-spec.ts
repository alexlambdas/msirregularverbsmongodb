...
describe('Module common-resources-mongodb (e2e)', () => {
    ...
    it('/ (GET_ALL) - success - http/200', () => {
        return request(httpServer)
            .get('/TestObject/microservice/crud/GET_ALL')
    ...
    it('/ (GET_BY_ID) - success - http/200', () => {
        return request(httpServer)
            .get('/TestObject/microservice/crud/GET_BY_ID/630bfc8bc221367c6deae074')
            .set('transactionid', 'PA20220131000005')
            .expect(200)
    });
    ...
    it('/ (DELETE_ONE) - success - http/200', () => {
        return request(httpServer)
            .del('/TestObject/microservice/crud/DELETE_ONE/630bfc8bc221367c6deae074')
            .set('transactionid', 'PA20220131000005')
            .expect(200)
    });
    ...
    it('/ (UPDATE_ONE) - success - http/200', () => {
        return request(httpServer)
            .put('/TestObject/microservice/crud/UPDATE_ONE/630bfdb2c221367c6deae07a')
            .set('transactionid', 'PA20220131000005')
            .send(
                {
                    "baseForm": "buy", 
    ...
    it('/ (GET_BY_ID) - error - id not found - http/400', () => {
        return request(httpServer)
            .get('/TestObject/microservice/crud/GET_BY_ID/630bfc8bc221367c6deae000')
            .set('transactionid', 'PA20220131000005')
            .expect(400)
    });
    ...
    it('/ (POST) - error - invalid URL - http/404', () => {
        return request(httpServer)
            .post('/TestObject/microservice/crud/POSTT')
            .set('transactionid', 'PA20220131000005')
            .send(
                {
                    "baseForm": "build", 
    ...
    it('/ (GET_BY_ID) - error - id not found - http/403', () => {
        return request(httpServer)
            .get('/TestObject/microservice/crud/GET_BY_ID/630bfc8bc221367c6deae002')
            .set('transactionid', 'PA20220131000005')
            .expect(500)
    });
    ...
    it('/ (GET_BY_ID) - error - id not found - http/500', () => {
        return request(httpServer)
            .get('/TestObject/microservice/crud/GET_BY_ID/630bfc8bc221367c6deae001')
            .set('transactionid', 'PA20220131000005')
            .expect(500)
    });
